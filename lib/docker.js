...
const runOnceSafe = function(inputDirectory, outputDirectory, options) {
  console.log('MK RUN ONCE SAFE');
  console.log('MK RUN ONCE SAFE inputDirectory:' + inputDirectory);
  console.log('MK RUN ONCE SAFE outputDirectory:' + outputDirectory);
  console.log('MK RUN ONCE SAFE options:' + JSON.stringify(options));
...
const runOnce = async function(inputDirectory, outputDirectory, options) {
  console.log('MK RUN ONCE');
  console.log('MK RUN ONCE inputDirectory:' + inputDirectory);
  console.log('MK RUN ONCE outputDirectory:' + outputDirectory);
  console.log('MK RUN ONCE options:' + JSON.stringify(options));
...
const getArgs = function(inputDirectory, outputDirectory, options) {
  console.log('\n\n\nMK GETARGS inputdirectory' + inputDirectory+ '\n\n\n');
  console.log('\n\n\nMK GETARGS outputdirectory' + outputDirectory + '\n\n\n');
  console.log('\n\n\nMK GETARGS options ' + JSON.stringify(options) + '\n\n\n');
  const runOptions = cli.getRunOptions(options);
  const chainActive = (runOptions[runopts.CHAIN_NAME] !== undefined);
  ...
  */
  console.log('\nrunopts ' + options.snapshot);
  console.log('\nrunopts ' + options.images);
  console.log('\nrunopts ' + options.closeBrowser);
  ...
  console.log('\n\n\nMK GETARKS BASEARGS' + JSON.stringify(baseArgs) + '\n\n\n');
  console.log('\n\n\nMK GETARKS args' + JSON.stringify(args) + '\n\n\n');
  return args;
}
