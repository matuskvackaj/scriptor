...
/**
 * String option that specifies that the run is part of a chain and how that
 * chain is named.
 */
const CHAIN_NAME = "chainName";
module.exports.CHAIN_NAME = CHAIN_NAME;
...
/**
 * Boolean option whether to delete the output directory before execution if it
 * exists (instead of failing).
 */
const OVERWRITE_OUTPUT = "overwriteOutput";
module.exports.OVERWRITE_OUTPUT = OVERWRITE_OUTPUT;
...
/**
 * String option that specifies a WARC file or directory of such to add to the
 * web archive for replay.
 */
const WARC_INPUT = "warcInput";
module.exports.WARC_INPUT = WARC_INPUT;
...
module.exports.CLOSE_BROWSER = CLOSE_BROWSER;
...
DEFAULT[OVERWRITE_OUTPUT] = false;
DEFAULT[PROXY] = false;
...
DEFAULT[WARC] = true;
DEFAULT[WARC_INPUT] = undefined;
module.exports.DEFAULT = DEFAULT;

/**
 * Sets the run option to not store the name of the chain
 * @param {object} runOptions - The run options object to change
 * @param {string} chainName - The name of the chain
 */
const setChainName = function(runOptions, chainName) {
  runOptions[CHAIN_NAME] = chainName;
}
module.exports.setChainName = setChainName;
...
/**
 * Sets the run option to delete the output directory before execution if it
 * exists (instead of failing).
 * @param {object} runOptions - The run options object to change
 */
const setOverwriteOutput = function(runOptions) {
  runOptions[OVERWRITE_OUTPUT] = true;
}
module.exports.setOverwriteOutput = setOverwriteOutput;
...
/**
 * Sets the WARC file or directory of such to add to the archive for replay.
 * @param {object} runOptions - The run options object to change
 * @param {string} warcInput - The file or directory
 */
const setWarcInput = function(runOptions, warcInput) {
  runOptions[WARC_INPUT] = warcInput;
}
module.exports.setWarcInput = setWarcInput;

//NEW
const setCloseBrowser = function(runOptions) {
  runOptions[CLOSE_BROWSER] = true;
}
module.exports.setCloseBrowser = setCloseBrowser;

const setImages = function(runOptions) {
  runOptions[SNAPSHOT] = true;
}
module.exports.setImages = setImages;

const setSnapshot = function(runOptions) {
  runOptions[IMAGES] = true;
}
module.exports.setSnapshot = setSnapshot;